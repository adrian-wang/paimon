...
class HiveFormatTableUtils {
    ...
    public static FormatTable convertToExternalTable(Table hiveTable) {
        ...
        String serLib = hiveTable.getSd().getSerdeInfo().getSerializationLib().toLowerCase();
        ...
        if (serLib.contains("parquet")) {
            ...
            options.put(FIELD_DELIMITER.key(), options.getOrDefault(FIELD_DELIM, "\u0001"));
        } else {
